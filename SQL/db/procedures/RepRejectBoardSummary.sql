...
BEGIN
	...
	begin
		...
		and runs.RecipeID between @recipeidstart and @recipeidend) = 0
			select rejectdescription='No Data',prodlabel='No Data',thicknominal=0,widthnominal=0,gradelabel='No Data',lengthnominal=0,lengthlabel='No Data',totalpieces=0,totalvolume=0
			
		else
			select rejectdescription, prodlabel,thicknominal,widthnominal,gradelabel,lengthnominal,lengthlabel,totalpieces=sum(boardcount),totalvolume=sum(thicknominal*widthnominal*lengthnominal*boardcount/144)
