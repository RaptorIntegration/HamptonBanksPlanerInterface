...
-- =============================================
CREATE pROCEDURE [dbo].[selectDisplayMessages2]
...
BEGIN
	...
	if (select count(*) from alarms,alarmsettings where stoptime is null and alarms.alarmid=alarmsettings.alarmid and Active=1 and Priority<1000 and SorterEligible='True') = 0 and (select count(*) from alarmsprevious,alarmsettings where stoptime is null and alarmsprevious.alarmid=alarmsettings.alarmid and Active=1 and Priority<1000 and SorterEligible='True') = 0
	...
	begin	--show alarms
		...
		where stoptime is null /*and displaytext <> ''*/ and alarms.alarmid = alarmsettings.alarmid and active = 1  and SorterEligible='True'
		...
		where stoptime is null /*and displaytext <> ''*/ and alarmsprevious.alarmid = alarmsettings.alarmid and active = 1  and SorterEligible='True'
	end
