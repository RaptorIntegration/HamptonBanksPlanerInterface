CREATE TABLE [dbo].[ProductionBoards] (
   ...
   ,CONSTRAINT [PK_ProductionBoards] PRIMARY KEY CLUSTERED ([ShiftIndex], [RunIndex], [ProdID], [LengthID], [ThickActual], [WidthActual], [LengthIn], [LengthInID], [NET], [FET], [CN2], [Fence], [Sorted], [SortCode])
)
