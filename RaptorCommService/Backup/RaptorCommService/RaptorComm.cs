...
namespace RaptorComm
{
    public static class RaptorCommService
    {
        ...
        static Tag cpuState = new Tag("$CPU_STATE");
        ...
        static Logix.Tag EncoderPosition = new Logix.Tag("EncoderPosition", Logix.Tag.ATOMIC.DINT);
        ...
        {
            public unsafe fixed uint TimingData[10];
        ...
        public static void UpdateRaptorCommLog(string text)
        {
            try{
                ...
                cmd.ExecuteNonQuery();
                SqlCommand cmd1 = new SqlCommand("delete from RaptorCommLog where id< (select max(id)-100 from RaptorCommLog)", connection);
        ...
        public static void StatusDataSentFromPLC()
        {
            ...
            while (true)
            {
                ...
                Tag myTag = new Tag("SystemStatus[0]", Logix.Tag.ATOMIC.DINT, 10);                                
                ///////////////////////////////////////
                // update the group
                try
                {
                    if (MyPLCStatus.IsConnected && oldWEBSortStatusCounter != WEBSortStatusCounter)
                    {
                        ...
                        {                          
                            ...
                            try
                            {
                                SqlCommand command = new SqlCommand("execute UpdateStatusData " + Convert.ToString(theData.GetValue(0)) + "," + Convert.ToString(theData.GetValue(1)) + "," + Convert.ToString(theData.GetValue(2)) + "," + Convert.ToString(theData.GetValue(3)) + "," + Convert.ToString(theData.GetValue(4)) + "," + Convert.ToString(theData.GetValue(5)) + "," + Convert.ToString(theData.GetValue(6)) + "," + Convert.ToString(theData.GetValue(7)) + "," + Convert.ToString(theData.GetValue(8)) + "," + Convert.ToString(theData.GetValue(9)), connection);
                                command.ExecuteNonQuery();
                                //Thread.Sleep(20);
                            }
                            catch(Exception ex){
        ...
        public static void ReadLugs()
        {
            ...
            while (true)
            {
                ...
                Tag myUDT = new Tag("WEBSortLugTable[" + WEBSortCounter + "]");
                                ...
                                if (Convert.ToInt16(lug.FrameStart) == Convert.ToInt16(lug.FrameEnd))
                                    if (Convert.ToInt16(lug.FrameStart) != LastFrameStart)
                                        if (bit[0] == false)
                                        {
                                            ...
                                            SqlCommand command = new SqlCommand("execute UpdateLugData " + lug.FrameStart.ToString() + "," + lug.LugNum.ToString() + "," + lug.TrackNum.ToString() + "," + lug.BayNum.ToString() + "," + lug.ProductID.ToString() + "," + lug.LengthID.ToString() + "," + lug.ThickActual.ToString() + "," + lug.WidthActual.ToString() + "," + lug.LengthIn.ToString() + "," + lug.Fence.ToString() + "," + lug.Saws.ToString() + "," + lug.NET.ToString() + "," + lug.FET.ToString() + "," + lug.CN2.ToString() + "," + lug.BayCount.ToString() + "," + lug.Volume.ToString() + "," + lug.PieceCount.ToString() + "," + lug.Flags.ToString() + "," + lug.Devices.ToString() + ",'" + bit[0].ToString() + "'," + lug.FrameEnd.ToString(), connection);
                                            command.ExecuteNonQuery();
        ...
        public static void BinDataSentFromPLC()
        {
            ...
            while (true)
            {
                ...
                Tag myUDT = new Tag("WEBSortBayTable[" + WEBSortBinCounter + "]");
                                ...
                                if (Convert.ToInt16(bin.FrameStart) == Convert.ToInt16(bin.FrameEnd))
                                    if (Convert.ToInt16(bin.FrameStart) != LastBinFrameStart)
                                        ...
                                        if (bit1[1] == false)  //false
                                        {
                                            ...
                                            //process data in database
                                            SqlCommand command = new SqlCommand("execute UpdateBinData " + bin.FrameStart.ToString() + "," + bin.BayNum.ToString() + ",'',0," + bin.Count.ToString() + ",'" + bit[6].ToString() + "'," + BinStatus.ToString() + ",0,0,'" + bit[5].ToString() + "'," + bin.SortXRef.ToString() + ",0,0,0,0,'" + bit[7].ToString() + "'," + bin.FrameEnd.ToString(), connection);
                                            command.ExecuteNonQuery();
                        ...
                        while (reader.Read())
                        {
                            ...
                            {          
                                ...
                                if (ProductsOnly == 0 || ProductsOnly == 2 || ProductsOnly == 3)  //write the entire UDT
                                {
                                    ...
                                    Tag udtRead = new Tag("WebSortBay[" + BinID + "]");
                                    Tag myUDT = new Tag("WebSortBay[" + BinID + "]");
                            ...
                            SqlCommand cmd12 = new SqlCommand("delete from DataRequestsBin where id <= (select max(id)-100 from DataRequestsBin)", connection);
                            cmd12.ExecuteNonQuery();
                        ...
                        while (reader.Read())
                        {
                            ...
                            if (Write == true) //writing data to the PLC
                            {
                                if (ProductsOnly == 0 || ProductsOnly == 2)  //write the entire UDT
                                {
                                    ...
                                    Tag udtRead = new Tag("WebSortTable[" + SortID + "]");
                                    Tag myUDT = new Tag("WebSortTable[" + SortID + "]");
                                    myUDT.DataType = Logix.Tag.ATOMIC.OBJECT;
                        ...
                        while (reader.Read())
                        {
                            ...
                            else //reading data from the PLC
                            {
                                ...
                                if (ResultCode.QUAL_GOOD == GraderMap.QualityCode)
                                {
                                    ...
                                    try
                                    {
                                        SqlCommand cmd0 = new SqlCommand("update datarequestsGradertest set Graders=" + GraderMap.Value.ToString() + ",Grades=" + GradeMap.Value.ToString() + ",Lengths=" + LengthMap.Value.ToString() + ",BayID=" + BayID.Value.ToString() + ",SampleSize=" + SampleSize.Value.ToString() + ",SamplesRemaining=" + SamplesRemaining.Value.ToString() + ",Interval=" + Interval.Value.ToString() + ",Active='" + Active.Value.ToString() + "',Stamp='" + Stamp.Value.ToString() + "',Trim='" + Trim.Value.ToString() + "' where id=" + reader["id"].ToString(), connection);
                                        cmd0.ExecuteNonQuery();
                                        SqlCommand cmd1 = new SqlCommand("update Gradertest set Graders=" + GraderMap.Value.ToString() + ",Grades=" + GradeMap.Value.ToString() + ",Lengths=" + LengthMap.Value.ToString() + ",BayID=" + BayID.Value.ToString() + ",SampleSize=" + SampleSize.Value.ToString() + ",SamplesRemaining=" + SamplesRemaining.Value.ToString() + ",Interval=" + Interval.Value.ToString() + ",Active='" + Active.Value.ToString() + "',Stamp='" + Stamp.Value.ToString() + "',Trim='" + Trim.Value.ToString() + "'", connection);
                                        cmd1.ExecuteNonQuery();
                            ...
                            else //reading data from the PLC
                            {
                                ...
                                if (ResultCode.QUAL_GOOD == dCommand.QualityCode)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        readermode.Close();
                                        SqlCommand cmd1 = new SqlCommand("update Drives set Command=" + dCommand.Value.ToString() + ",Actual=" + dActual.Value.ToString() + ",Length" + LengthID.ToString() + "Multiplier=" + dSpeedMultiplier.Value.ToString() + " where DriveID = " + DriveID + " and RecipeID = (select recipeid from recipes where online=1)", connection);
                ...
                if ((DataRequests & 256) == 256)
                {
                    ...
                    try
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            bool Write = bool.Parse(reader["Write"].ToString());
                            uint TimingData1 = uint.Parse(reader["Item1Value"].ToString());
                            uint TimingData2 = uint.Parse(reader["Item2Value"].ToString());
                            uint TimingData3 = uint.Parse(reader["Item3Value"].ToString());
                            uint TimingData4 = uint.Parse(reader["Item4Value"].ToString());
                            uint TimingData5 = uint.Parse(reader["Item5Value"].ToString());
                            uint TimingData6 = uint.Parse(reader["Item6Value"].ToString());
                            uint TimingData7 = uint.Parse(reader["Item7Value"].ToString());
                            uint TimingData8 = uint.Parse(reader["Item8Value"].ToString());
                            uint TimingData9 = uint.Parse(reader["Item9Value"].ToString());
                            uint TimingData10 = uint.Parse(reader["Item10Value"].ToString());                            

                            if (Write == true) //writing data to the PLC
                            {
                                // encode TimingREADWRITE for writing  
                                Tag udtRead = new Tag("WebSortTiming[" + TimingID + "]");
                                Tag myUDT = new Tag("WebSortTiming[" + TimingID + "]");
                                myUDT.DataType = Logix.Tag.ATOMIC.OBJECT;
            ...
            while (true)
            {
                ...
                try
                {
                    if (MyPollPLC.IsConnected)
                    {
                        ...
                        //PollUDTGroup.AddTag(ProductLength);
                        //PollUDTGroup.AddTag(PlanerSpeed);
                ...
                if (ResultCode.QUAL_GOOD == pollcount.QualityCode)
                {
                    try
                    {
                        ...
                        if (Firstscan)
                        {
                            ...
                            {
                                SqlCommand cmd4 = new SqlCommand("execute UpdateStatusDataWEBSort 323,1", connection);
                            ...
                            {
                                SqlCommand cmd5 = new SqlCommand("execute UpdateStatusDataWEBSort 323,0", connection);
