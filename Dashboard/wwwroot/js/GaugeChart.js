(function () {
    ...
    GaugeChartHelper.prototype.applyGaugeConfig = function (chartConfig) {
        ...
        var padding = Math.max.apply(this, labelsWidth) + this.chart.width / 10;
    ...
    GaugeChartHelper.prototype.animateArrow = function () {
        var interval = setTimeout(function () {
            this.clearValueArrow(0)
            this.clearValueArrow(this.data.value - this.minValue);
            this.renderSmallValueArrow(this.data.value - this.minValue);
            this.renderValueArrow(this.data.value - this.minValue);
        }.bind(this), 0);
    };
    ...
    Chart.controllers.tsgauge = Chart.controllers.doughnut.extend({
        ...
        draw: function () {
            ...
            gaugeHelper.setup(this.chart, this.chart.config);
            gaugeHelper.applyGaugeConfig(this.chart.config);
            gaugeHelper.updateGaugeDimensions();
