<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/WebSort.Master" AutoEventWireup="true" CodeBehind="DeviceDiagnostics.aspx.cs" Inherits="WebSort.DeviceDiagnostics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <tr>
                            ...
                            <ContentTemplate>
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="style16">
                                            <asp:TextBox ID="TextBoxParameterDescription" runat="server" placeholder="Enter test frequency (seconds x 1000) ie. 1000 = 1s"
                                                BackColor="#A4A4A4"
            ...
            <td valign="top">
                <asp:UpdatePanel ID="UpdatePanel11" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Label ID="Labelenc" runat="server" BorderStyle="Solid"
    ...
    <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" Visible="false"
        CssFilePath="~/App_Themes/BlackGlass/{0}/styles.css" CssPostfix="BlackGlass"
        SaveStateToCookies="True" Width="922px">
        <TabPages>
            <dx:TabPage Text="Diagnostic Tests">
                <ContentCollection>
                                    ...
                                    <asp:UpdatePanel runat="server" UpdateMode="Conditional" ID="UpdatePanel9">
                                        <ContentTemplate>
                                            <asp:Button ID="ButtonAddNewMode0" runat="server" CausesValidation="False"
                                                OnClick="ButtonAddNewMode0_Click" Text="Add New Mode" Width="125px" />
                                            <asp:Button ID="ButtonRenameItem0" runat="server" CausesValidation="False"
                                                OnClick="ButtonRenameItem0_Click" Text="Rename Mode" Width="125px" />
                                            <asp:Button ID="ButtonDeleteItem0" runat="server" CausesValidation="False"
                                                OnClick="ButtonDeleteItem0_Click" Text="Delete Mode" Width="125px" />
                                            <asp:Button ID="ButtonChangeItemID0" runat="server" CausesValidation="False"
                                                OnClick="ButtonChangeItemID0_Click" Text="Change Mode ID" Width="125px" />
                                            <br />
                                            <br />
    ...
    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
        <ContentTemplate>
            <asp:Button ID="ButtonRefreshAll" runat="server" 
